...
const az: Translations = {
  ...
  'sectors.metric.topDriver.label': '2014–2021 Əsas İnkişaf Sürücüsü',
  'sectors.metric.peakContrib.value': 'Xidmətlər',
  'sectors.metric.peakContrib.label': '2005–2008 Pik Töhfəçi',
  'sectors.metric.drag.value': 'Əmək Bazarı',
  'sectors.metric.drag.label': '2010–2019 Dominant Əyləc',
  ...
  'sectors.callout.topDriver': 'Əsas İnkişaf Sürücüsü',
  'sectors.callout.topDrag': 'Ən Böyük Əyləc',
  'sectors.callout.dominantSector': 'Ən Tez-tez Lider',
  'sectors.callout.years': 'il lider sektoru',
  'sectors.tab.oilBoom': 'Neft Bumu 2005–2008',
  'sectors.tab.postCrisis': 'Böhran Sonrası 2014–2020',
  ...
  'home.finding.pullquote': 'Barrel başına 80 ABŞ dolları sabit neft qiyməti şəraitində Azərbaycanın neft-qaz sektorunun ÜDM-dəki payı 2033-cü ilə qədər 20% siyasət həddinə çatacaq — bu, illik −2.5% struktur yataq tükənməsi və 4.5% qeyri-neft sektoru artımı ilə şərtlənir.',
